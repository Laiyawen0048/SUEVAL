...
# ---------- Read data ----------
data_path = r"C:\Users\沐阳\Desktop\城市得分结果_pro\city_Dscore_chongqing.xlsx"
...
ax_main.set_ylabel("Score",fontweight="bold")
ax_main.set_title("City Dimension Scores Over Years",fontweight="bold")
